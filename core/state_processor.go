...
func (p *StateProcessor) Process(block *types.Block, statedb *state.StateDB, cfg vm.Config) (types.Receipts, []*types.Log, uint64, error) {
	...
	*/
	...
	defer cmFile.Close()
	if stats.NumContracts > 0 {
		if _, err := cmFile.WriteString(fmt.Sprintf("%d, %d, %d, %d, %d, %d, %d\n", block.NumberU64(), stats.ProofSize, stats.CodeSize, stats.ProofStats.Indices, stats.ProofStats.ZeroLevels, stats.ProofStats.Hashes, stats.ProofStats.Leaves)); err != nil {
			return nil, nil, 0, err
		}
	}
